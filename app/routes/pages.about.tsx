    ...
    <section className="relative overflow-hidden bg-ink text-white">
      ...
      <div className="ui-container relative py-20 md:py-28">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link to="/consign" className="btn btn-ghost">
            Sell &amp; consign
          </Link>
        </div>
      </div>
    ...
    <section className="bg-mint">
      <div className="ui-container flex flex-col items-center gap-6 py-16 text-center md:py-24">
        ...
        <p className="max-w-xl text-muted">
          Browse the curated collection of new and pre-loved homeware — or send
          us the pieces you no longer use and let them find a new home.
        </p>
