...
export type SellerScanQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type SellerScanQuery = {
  products: {
    nodes: Array<
...
export type SyncProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type CustomBandanaQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CustomBandanaQuery = {
...
export type StudioBandanaQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type StudioBandanaQuery = {
  product?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query SellerScan($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    products(first: 250) {\n      nodes {\n        id\n        handle\n        title\n        vendor\n        featuredImage {\n          id\n          altText\n          url\n          width\n          height\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n          maxVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        seller: metafield(namespace: "custom", key: "seller") {\n          reference {\n            ... on Metaobject {\n              handle\n              slug: field(key: "slug") {\n                value\n              }\n              displayName: field(key: "display_name") {\n                value\n              }\n              bio: field(key: "bio") {\n                value\n              }\n              verified: field(key: "verified") {\n                value\n              }\n              logo: field(key: "logo") {\n                reference {\n                  ... on MediaImage {\n                    image {\n                      url\n                      altText\n                    }\n                  }\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: SellerScanQuery;
    variables: SellerScanQueryVariables;
  };
  ...
  '#graphql\n  query SyncProducts($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    products(first: 250) {\n      nodes {\n        id\n        title\n        vendor\n        variants(first: 1) {\n          nodes {\n            sku\n          }\n        }\n      }\n    }\n  }\n': {
    return: SyncProductsQuery;
    variables: SyncProductsQueryVariables;
  };
  ...
  '#graphql\n  query CustomBandana(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      descriptionHtml\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      options {\n        name\n        optionValues {\n          name\n        }\n      }\n      images(first: 6) {\n        nodes {\n          url\n          altText\n        }\n      }\n      variants(first: 20) {\n        nodes {\n          id\n          title\n          availableForSale\n          image {\n            url\n            altText\n          }\n          price {\n            amount\n            currencyCode\n          }\n          selectedOptions {\n            name\n            value\n          }\n        }\n      }\n    }\n  }\n': {
    return: CustomBandanaQuery;
    variables: CustomBandanaQueryVariables;
  };
  '#graphql\n  query StudioBandana(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      id\n      title\n      images(first: 6) {\n        nodes {\n          url\n        }\n      }\n      variants(first: 20) {\n        nodes {\n          id\n          title\n          image {\n            url\n          }\n          price {\n            amount\n            currencyCode\n          }\n          selectedOptions {\n            name\n            value\n          }\n        }\n      }\n    }\n  }\n': {
    return: StudioBandanaQuery;
    variables: StudioBandanaQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
